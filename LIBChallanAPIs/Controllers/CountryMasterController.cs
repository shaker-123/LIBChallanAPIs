...
namespace LIBChallanAPIs.Controllers
{
    ...
    public class CountryMastersController : ControllerBase
    {
        ...
        public CountryMastersController(ICountryMasterRepository repository)
        {
        ...
        {
            var result = await _repository.GetByCountryNameAsync(code);
            if (result == null)
                return NotFound();
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CountryMasterCreateDto dto)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] CountryMasterUpdateDto dto)
        {
        ...
        public async Task<IActionResult> ToggleActive([FromBody] CountryMasterToggleActiveDto dto)
        {
